                ...
                <CardContent className="flex flex-wrap items-center gap-4 py-4">
                  ...
                  <div className="flex gap-1">
                    ...
                    <Button
                      ...
                      size="icon"
                      render={
                        <a href={buildWhatsAppLink(booking.phone, `Hi ${booking.fullName}, this is 211Motors regarding your booking.`)} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
