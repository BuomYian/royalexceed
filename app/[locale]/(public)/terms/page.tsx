  ...
  return (
    <div className="container-brand py-10 sm:py-14">
      ...
      <div className="prose prose-neutral dark:prose-invert mx-auto mt-6 max-w-3xl">
        ...
        <h2>About 211Motors</h2>
        <p>
          211Motors, in partnership with FBM International Co., is the sole authorized distributor of Soueast
        ...
        <p>
          All new vehicles sold by 211Motors carry the manufacturer warranty described on the relevant
          model page. Warranty coverage is contingent on the use of genuine Soueast or 212 parts and service
          performed by an authorized 211Motors technician.
        </p>
        ...
        <h2>Contact</h2>
        <p>
          For questions about these terms, contact 211Motors at {settings.email} or {settings.phone}.
        </p>
      </div>
    </div>
  );
